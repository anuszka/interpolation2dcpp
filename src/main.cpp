...
// GslInterp2dTypehe following example performs bilinear interpolation on the unit square, 
...
main()
{
  const gsl_interp2d_type *GslInterp2dType = gsl_interp2d_bilinear;
  ...
  gsl_spline2d *spline = gsl_spline2d_alloc(GslInterp2dType, nx, ny);
